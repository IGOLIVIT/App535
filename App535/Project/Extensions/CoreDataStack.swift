...
//    func updateGoal(gName: String, gNewBalance: String?) {
//            let context = persistentContainer.viewContext
//            let fetchRequest: NSFetchRequest<PiggyModel> = PiggyModel.fetchRequest()
//            fetchRequest.predicate = NSPredicate(format: "gName == %@", gName)
//            
//            do {
//                let films = try context.fetch(fetchRequest)
//                
//                if let film = films.first {
//                    // Обновляем атрибуты фильма, если они переданы
//                    if let gNewBalance = gNewBalance {
//                        film.gSBalance = gNewBalance
//                    }
//                    
//                    try context.save()
...
//                }
//            } catch let error {
//                print("Failed to fetch or update film: \(error)")
//            }
//        }
